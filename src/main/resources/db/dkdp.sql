/*
 ...
 Date: 24/04/2024 11:18:42
*/

-- 创建库
create database if not exists dkdp;
...
INSERT INTO `tb_blog` VALUES (8, 1, 7, '测试', '/imgs/blogs/14/11/5fccdcf0-8bd2-456f-930a-49ebb073769d.png', '不错', 4, NULL, '2024-04-01 14:25:14', '2024-04-23 22:32:50');
INSERT INTO `tb_blog` VALUES (10, 2, 2, '你好', '/imgs/blogs/3/15/8b17ad17-0c3c-48a2-b6cc-9eb8678fd494.png', '好的', 0, NULL, '2024-04-01 15:19:26', '2024-04-01 15:19:26');
...
-- ----------------------------
INSERT INTO `tb_follow` VALUES (1, 7, 2, '2024-04-01 15:06:31');
INSERT INTO `tb_follow` VALUES (3, 1, 2, '2024-04-01 15:13:14');
...
CREATE TABLE `tb_seckill_voucher`  (
                                       ...
                                       `create_time` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
                                       `begin_time` timestamp(0) NULL DEFAULT NULL COMMENT '生效时间',
